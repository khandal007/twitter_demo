...
module.exports = {
  ...
  attributes: {
    ...
    mobile: {
      type: 'string',
      description: 'Full representation of the user\'s mobile number',
      maxLength: 20,
      unique: true,
      allowNull: true
    },
...
email status until they click the link in the confirmation email.`,
    ...
    smtpMail: {
      type: 'string',
      columnType: 'varchar(255)',
      description: 'The from mail',
      allowNull: true
    }, 
    smtpPassword: {
      type: 'string',
      columnType: 'varchar(255)',
      description: 'The from mail password',
      allowNull: true
    },
    tosAcceptedByIp: {
      type: 'string',
    ...
    loginVia:{
      ...
      columnType: 'tinyint',
      defaultsTo:1,
      description:'1 for app, 2 for facebook,3 for google'
    },
    viaId:{
      type:'string',
      description:'FB or Google user ID',
      allowNull: true
    },
    userRole:{
      type:'number',
      columnType: 'tinyint',
      defaultsTo:45,
      description:'45 for moderator, 55 for Admin and 65 for Super Admin'
    },
    userLogin:{
      type:'string',
      columnType: 'varchar(100)',
      description:'10 for panel and 20 for document',
      defaultsTo:'10',
    },
    isActive:{
      type:'number',
    ...
    tweet_logs:{
        collection:'TweetLogs',
        via:"request_user_id"
    }
    
    // excelUser:{
    //   collection:"ExcelLogs",
    //   via:"createdBy"
    // }
